...
$merchant_order_id = isset($_GET['merchant_order_id']) ? $_GET['merchant_order_id'] : "";
$preference_id = isset($_GET['preference_id']) ? $_GET['preference_id'] : "";
$site_id = isset($_GET['site_id']) ? $_GET['site_id'] : "";
$processing_mode = isset($_GET['processing_mode']) ? $_GET['processing_mode'] : "";
$merchant_account_id = isset($_GET['merchant_account_id']) ? $_GET['merchant_account_id'] : "";
        ...
        <div class="as-search-wrapper" role="main">
            ...
            <div class="as-search-results as-filter-open as-category-landing as-desktop" id="as-search-results">
                <form action="index.php" method="get" style = "text-align: center;">
                    ...
                    <p>Tu compra fue completada, estos son los datos</p>
                    <p>collection_id: <?php echo $collection_id ?></p>
                    <p>collection_status: <?php echo $collection_status ?></p>
                    <p>payment_id: <?php echo $payment_id ?></p>
                    <p>status: <?php echo $status ?></p>
                    <p>external_reference: <?php echo $external_reference ?></p>
                    <p>payment_type: <?php echo $payment_type ?></p>
                    <p>merchant_order_id: <?php echo $merchant_order_id ?></p>
                    <p>preference_id: <?php echo $preference_id ?></p>
                    <p>site_id: <?php echo $site_id ?></p>
                    <p>processing_mode: <?php echo $processing_mode ?></p>
                    <p>merchant_account_id: <?php echo $merchant_account_id ?></p>
                    <button type="submit" class="mercadopago-button" formmethod="post">Volver al inicio</button>
                    <br><br>
                </form>
            </div>
